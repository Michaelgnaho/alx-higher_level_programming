Readme documenttion for 0x0C-python-almost_a_circle

# Python - Almost a circle

![Circle](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/331/giphy.mp4)
In this project, I gather skills in Python object-oriented programming (OOP)by coding three connected classes as a protoype of rectangles and squares. I wrote my own test suite using the `unittest` module to test all functionality for each class.
...
* [tests/test_models](./tests/test_models): This is the folder containing the following independently-developed test files:
...
### Base
This represents the "base" class for all other classes in the project. Includes:
...
This represents a rectangle. Inherits from `Base` with:
